...
* To call a function, we can type its name, followed by open and closing parentheses
...
* when you have vectors, you can run operations over all of them at once
...
* this ability to run an operation over all elements in a vector is called vectorization
* it's built into R and makes R very powerful because we don't have to write loops to do this
* 
